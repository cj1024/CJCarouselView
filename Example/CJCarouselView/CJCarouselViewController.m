...
- (void)viewControllerReloadData {
    ...
    self.imageUrls = @[
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=0", timestamp],
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=1", timestamp],
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=2", timestamp],
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=3", timestamp],
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=4", timestamp],
        [NSString stringWithFormat:@"https://bing.ee123.net/img/rand?w=800x600&t=%lld&i=5", timestamp]
    ];
